...
import footerData from '../Footer/footer data/Footer'
            ...
            <div className="footer">
                <div className="footer-content">
                    <div className="footer-left">
                        <img src="https://fabrx.co/fullpreview/tastebite/assets/images/brands/brand4.svg" alt="Brand logo" />
                        <p>"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of <br /> the moment</p>
                    </div>
                    <div className="footer-right">
                        {footerData.map((section, index) => (
                            <div key={index} className="footer-section">
                                <h4 className='tittle'>{section.title}</h4>
                                <ul>
                ...
                <div className="TM-content">
                    <h3>© 2020 Tastebite - All rights reserved</h3>
